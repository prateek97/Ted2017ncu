                ...
                <div class="col-sm-4 portfolio-item">
				 ...
				 <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                 <p>Ankur Warikoo</p>
							<p>Co founder, CEO - Nearbuy</p>
                            </div>
                        </div>
                        <img src="images/speakers/aw.jpg" class="img-responsive" alt="Safe">
                    </a>
                </div>
				 <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal7" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                 <p>Saumya Kulshreshtha</p>
							<p>writer, teacher, blogger</p>
                            </div>
                        </div>
                        <img src="images/speakers/sk.jpg" class="img-responsive" alt="Safe">
                    </a>
                </div>
				 ...
				 <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal8" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="images/speakers/divya.jpg" class="img-responsive" alt="Safe">
                    </a>
                </div>
    ...
    <section id="portfolio1">
        <div class="container">
            ...
            <div class="row">
                ...
                <img src="images/team/kshitez.jpeg" class="img-responsive img-circle" alt="">
                    <p style="font-family:SansRegular;font-size:1.2em;margin-bottom:0;font-weight:bold;text-align:center;">kshitez Kaushik</p>
        ...
        <div class="row" style="margin-bottom:10vh;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 text-center" style="padding-left:45px;padding-right:45px;">
                <img src="images/team/prateek.jpg" class="img-responsive img-circle" alt="">
                    ...
                    <p style="font-family:SansLight;margin-bottom:0;font-size:1.1em;text-align:center;">Web & Graphic Design</p>
                       <p style="font-family:SansLightIt;font-size:0.9em;margin-bottom:0;text-align:center;"></p>
                      <ul class="list-inline social-buttons">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Ankur Warikoo</h2>
                            <hr class="star-primary">
                            <img src="images/speakers/aw1.jpg" class="img-responsive img-centered" alt="">
                            <p>Ankur Warikoo is an Internet entrepreneur and Angel Investor based in India. He is the Co-founder and CEO of nearbuy. He was previously an Entrepreneur-in-Residence at Rocket Internet, Co-founder at Accentium Web, Management Consultant at A.T</p>
                            <ul class="list-inline item-details">
        ...
        <div class="modal-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Saumya Kulshreshtha</h2>
                            <hr class="star-primary">
                            <img src="images/speakers/sk1.jpg" class="img-responsive img-centered" alt="">
                            <p>Saumya is a writer, teacher, voice-over artist and a communications and content professional. She is the Founder of Poets' Collective, and also curates a mythology-based community called Maha Varta. She teaches communications to school students and poetry and mythology to college students.She also organizes literature, poetry and cinema festivals and has been on many panels pan-India.</p>
                            <ul class="list-inline item-details">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>RJ Divya</h2>
                            <hr class="star-primary">
                            <img src="images/speakers/dddd.jpg" class="img-responsive img-centered" alt="">
                            <p></p>
                            <ul class="list-inline item-details">
